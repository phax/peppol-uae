...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="default">
    ...
    <rule context="/pxs:TaxData">
      ...
      <assert id="ibr-tdd-05" flag="fatal" test="matches(normalize-space(cbc:IssueTime), '^(?:[01]\d|2[0-3]):[0-5]\d:[0-5]\d(.\d{1,9})?(?:Z|[+-](?:0\d|1[0-4]):[0-5]\d)$')"
    ...
    <rule context="/pxs:TaxData/pxs:ReportedTransaction/pxs:CustomContent">
      ...
      <!-- UAE only allows the simple cbc:Value element
           As the XSD uses "choice" the existence of Value implicitly forbids ExtensionContent element existance
      -->
